tiled --export-map csv ./maps/start.tmx ./public/assets/maps/start.csv
tiled --export-map csv ./maps/northHall.tmx ./public/assets/maps/northHall.csv
tiled --export-map csv ./maps/eastHall.tmx ./public/assets/maps/eastHall.csv
